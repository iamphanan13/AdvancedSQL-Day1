...
select e.employee_id, first_name + " " + last_name as full_name, job_title, salary, department_name
...
as
begin
	select e.employee_id,first_name + ' ' + last_name as Fullname, hire_date,job_title, min_salary,department_name
	from jobs j join employees e on j.job_id = e.job_id
			join departments d on e.department_id = d.department_id;
end
